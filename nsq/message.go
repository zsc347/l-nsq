...
// return (FIN/REQ based on the error value returned).
//
...
// will be respond to automatically
...
// Finish send a FIN command to the nsqd which sent this message
...
// send this messasge, using the supplied delay
//
...
func DecodeMessage(b []byte) (*Message, error) {
	...
	if len(b) < 10+MsgIDLength {
		return nil, errors.New("not enought data to decode valid message")
	}
