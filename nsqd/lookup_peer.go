...
// gracefully (i.e. it is all handled by the library). Clients can simply use
// the Command interface to perform a round-trip
...
// peerInfo contains metadata for a lookupPeer instance (and is JSON marchalable)
...
// rconnecting in the event of a failure.
//
